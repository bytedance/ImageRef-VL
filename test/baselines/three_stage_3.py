...
from stage3_collator import ImageRefIPPCollator, ICImageRefIPPCollator
...
def parse_args():
    ...
    parser.add_argument("--method_name", default="i4p-ic", type=str)
    parser.add_argument(
        "--data_dir",
        default="",
        type=str,
...
if __name__ == "__main__":
    ...
    stage1_rslt = {}
    with jsonlines.open(args.stage1_file, 'r') as reader:
        for obj in reader:
            stage1_rslt[obj["id"]] = obj["result"].strip("`\n ")
    ...
    if method.is_in_context:
        ...
        collate_fn = ICImageRefIPPCollator(stage1_rslt, in_context_examples, args.num_ic_examples)
    else:
        collate_fn = ImageRefIPPCollator(stage1_rslt)
